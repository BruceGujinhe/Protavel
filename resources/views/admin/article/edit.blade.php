    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div id="protavel-mainbody">
                ...
                <form action="{{ route('admin.article.update', ['id' => $article->id]) }}" method="POST" class="form form-horizontal">
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="string" name="title" class="form-control" id="input-title" placeholder="" value="{{ old('title', $article->title) }}">
                            @if ($errors->has('title'))
                    ...
                    <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                        <label for="input-site-name" class="col-sm-2 control-label">标题</label>
                        <div class="col-sm-10">
                            <textarea name="content" class="form-control" id="input-content" rows="8" placeholder="">{{ old('content', $article->content) }}</textarea>
