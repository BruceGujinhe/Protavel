        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div id="protavel-mainbody">
                    <p class="h3 text-center">编辑单页</p>
                    <br><br>

                    <form action="{{ route('admin.page.update', ['id' => $page->id]) }}" method="POST" class="form form-horizontal">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="string" name="name" class="form-control" id="input-name"
                                       placeholder="" value="{{ old('name', $page->name) }}">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('link') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="string" name="link" class="form-control" id="input-link"
                                       placeholder="" value="{{ old('link', $page->link) }}">
                                @if ($errors->has('link'))
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="string" name="title" class="form-control" id="input-title"
                                       placeholder="" value="{{ old('title', $page->title) }}">
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 {{ $errors->has('content') ? 'has-error' : '' }}">
                                <textarea name="content" id="editor" rows="8" placeholder="">{{ old('content', $page->content) }}</textarea>
